...
// This configuration normally comes from Figma's private preview metadata, which is not included in downloaded projects.
const siteConfiguration: FigmaSiteConfiguration = {
  title: 'Mispha Ministries',
  description: 'Church, mission, and training.',
  language: 'en',
}
